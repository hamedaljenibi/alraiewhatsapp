...
export type CategoryKey = "tracking" | "weatherRisk" | "order" | "system";

export type Categories = Partial<Record<CategoryKey, NotificationChannelSetting>>;

export interface NotificationPreferences {
  all: NotificationChannelSetting;
  categories: Categories;
  types: Record<string, NotificationChannelSetting>;
}
...
const userSchema = new Schema<IUserDocument>(
  {
    ...
    permissions: {
      ...
      geofence: {
        ...
        delete: { type: Boolean, default: true },
        view: { type: Boolean, default: true },
        animalView: { type: Boolean, default: true },
        animalAdd: { type: Boolean, default: true },
        animalDelete: { type: Boolean, default: true },
      },
      report: {
        add: { type: Boolean, default: true },
        edit: { type: Boolean, default: true },
    ...
    homepageSections: {
      ...
      gpsScanner: { type: Boolean, default: true },
      weather: { type: Boolean, default: true },
      animalStats: { type: Boolean, default: true },
    },
